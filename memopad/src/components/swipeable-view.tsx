...
import { SharedValue, interpolate, runOnJS, useAnimatedGestureHandler, useAnimatedStyle, useDerivedValue, useSharedValue, withTiming } from 'react-native-reanimated'
...
interface BackViewProps {
    ...
    const SwipeableView = forwardRef<SwipeableViewHandle, Props>((props, ref) => {
        ...
        const panGesture = useAnimatedGestureHandler<PanGestureHandlerGestureEvent>({
            onActive: event => {
                const x = interpolate(event.translationY, [-SCREEN_WIDTH, 0], [-1, 0])
